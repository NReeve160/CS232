...
public:
   ...
   {  // setup
      custom::priority_queue pqSrc;
      // exercise
      custom::priority_queue pqDest(pqSrc);
      // verify
   ...
   {  // setup
      custom::priority_queue pqSrc;
      // exercise
      custom::priority_queue pqDest(std::move(pqSrc));
      // verify
      assertEmptyFixture(pqSrc);
      assertEmptyFixture(pqDest);
   }  // teardown
   ...
   {  // setup
      ...
      // exercise
      custom::priority_queue pq(il.begin(), il.end());
      // verify
   ...
   {  // setup
      custom::vector  v;
      // exercise
      custom::priority_queue  pq(std::move(v));
      // verify
      assertEmptyFixture(pq);
      assertUnit(v.size() == 0);
      // teardown
   ...
   {  // setup
      //   v = [50]
      custom::vector  v{int(50)};
      // exercise
      custom::priority_queue  pq(v);
      // verify
      //  +----+
      //  | 50 |
      //  +----+
   ...
   {  // setup
      //   v = [10,9,8]
      custom::vector  v{int(10), int(9), int(8)};
      // exercise
      custom::priority_queue  pq(v);
      // verify
      //  +---+---+---+
   ...
   {  // setup
      custom::priority_queue  pqLHS;
      custom::priority_queue  pqRHS;
      // exercise
      swap(pqLHS, pqRHS);
      // verify
   ...
   ***************************************/
    ...
    *   +---+---+---+---+---+---+---+---+---+
    ***************************************************/
   void setupStandardFixture(custom::priority_queue & pq)
   {
    ...
    ***************************************************/
   void assertEmptyFixtureParameters(const custom::priority_queue & pq, int line, const char* function)
   {
    ...
    *   +---+---+---+---+---+---+---+---+---+
    ***************************************************/
   void assertStandardFixtureParameters(const custom::priority_queue & pq, int line, const char* function)
   {
    ...
    *   +---+---+---+---+---+---+---+
    ***************************************************/
   void assertTightFixtureParametersX(const custom::priority_queue & pq, int line, const char* function)
   {
      assertIndirect(pq.container.size() == 7);
    ...
    *   +---+---+---+---+---+---+---+---+---+---+
    ***************************************************/
   void teardownStandardFixture(custom::priority_queue & pq)
   {
      pq.container.empty();
   }
};
