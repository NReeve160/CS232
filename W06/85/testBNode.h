...
public:
   ...
   {  // setup
      ...
      //       +----+----+           +----+----+
      //      (26)      (49)        (64)      (85)
      BNode * pSrc = setupStandardFixture();
      BNode * pDest = nullptr;
      // exercise
      pDest = copy(pSrc);
      // verify
   ...
   {  // setup
      ...
      //       +----+----+           +----+----+
      //      (26)      (49)        (64)      (85)
      BNode * pDest = setupStandardFixture();
      // exercise
      assign(pDest, pSrc);
      // verify
      assertUnit(pSrc == nullptr);
   ...
   {  // setup
      ...
      //       +----+----+           +----+----+
      //      (26)      (49)        (64)      (85)
      BNode * pRHS = setupStandardFixture();
      // exercise
      swap(pLHS, pRHS);
      // verify
      //                      (50) = pLHS
   ...
   {  // setup
      ...
      //       +----+----+           +----+----+
      //      (26)      (49)        (64)      (85)
      BNode * pLHS = setupStandardFixture();
      BNode * pRHS = nullptr;
      // exercise
      swap(pLHS, pRHS);
      // verify
   ...
   {  // setup
      //                      (50) = p50
      BNode * p50 = new BNode (50);
      BNode * p99 = new BNode (99);
      // exercise
      addLeft(p50, p99);
      // verify
      //                      (50) = p50
   ...
   {  // setup
      ...
      //           (38) = p38            (73) = p73
      BNode * p50 = new BNode (int(50));
      BNode * p38 = new BNode (int(38));
      BNode * p73 = new BNode (int(73));
      p50->pLeft = p38;
      p50->pRight = p73;
      ...
      //            +----------+----------+
      //           (61) = p61            (67) = p67
      BNode * p64 = new BNode (int(64));
      BNode * p61 = new BNode (int(61));
      BNode * p67 = new BNode (int(67));
      p64->pLeft = p61;
      p64->pRight = p67;
   ...
   {  // setup
      ...
      //            +----------+----------+
      //           (42) = p42            (49) = p49
      BNode * p44 = new BNode (int(44));
      BNode * p42 = new BNode (int(42));
      BNode * p49 = new BNode (int(49));
      p44->pLeft = p42;
      p44->pRight = p49;
    ...
    *  (26)       (49)       (64)       (85)
    *************************************************************/
   BNode * setupStandardFixture()
   {
      // allocate
      BNode * p50 = new BNode (int(50));
      BNode * p38 = new BNode (int(38));
      BNode * p73 = new BNode (int(73));
      BNode * p26 = new BNode (int(26));
      BNode * p49 = new BNode (int(49));
      BNode * p64 = new BNode (int(64));
      BNode * p85 = new BNode (int(85));
    ...
    *  (26)       (49)       (64)       (85)
    *************************************************************/
   void assertStandardFixtureParameters(const BNode * pRoot, int line, const char *function)
   {
      // verify root
    ...
    *   ( )       ( )         ( )       ( )
    *************************************************************/
   void teardownStandardFixture(BNode * pRoot)
   {
      if (nullptr != pRoot)
      {
