...
public:
   ...
   {  // setup
      std::vector<int> v{59, 67, 31, 49};
      // exercise
      custom::unordered_set<int> us(v.begin(), v.end());
      // verify
      //      h[0] -->
      //      h[1] --> 31
      //      h[2] -->
   ...
   {  // setup
      ...
      //      h[8] -->
      //      h[9] -->
      custom::unordered_set<int> usSrc;
      // exercise
      custom::unordered_set<int> usDes(usSrc);
      // verify
      //      h[0] -->
      //      h[1] -->
      //      h[2] -->
   ...
   {  // setup
      ...
      //      h[9] -->
      custom::unordered_set<int> usSrc;
      custom::unordered_set<int> usDes;
      // exercise
      usDes = usSrc;
      // verify
      //      h[0] -->
   ...
   {  // setup
      ...
      //      h[9] -->
      custom::unordered_set<int> us;
      custom::unordered_set<int>::iterator it;
      Spy::reset();
      // exercise
      it = us.begin();
      // verify
   ...
   {  // setup
      ...
      //      h[9] -->
      custom::unordered_set<int> us;
      custom::unordered_set<int>::iterator it = us.end();
      // exercise
      ++it;
      // verify
      assertUnit(it.pBucket == us.buckets + 10);
   ...
   {  // setup
      ...
      custom::unordered_set<int> us;
      setupStandardFixture(us);
      custom::unordered_set<int>::local_iterator it;
      // exercise
      it = us.begin(1);
      // verify
      //      h[0] -->
   ...
   {  // setup
      ...
      //      h[9] -->
      custom::unordered_set<int> us;
      custom::unordered_set<int>::iterator it = us.begin();
      // exercise
      it = us.find(99);
      // verify
      assertUnit(it.pBucket == us.buckets + 10);
   ...
   {  // setup
      ...
      //      h[9] -->
      custom::unordered_set<int> us;
      custom::pair<custom::unordered_set<int>::iterator, bool> p;
      // exercise
    ...
    *      h[9] --> 59 49
    *************************************************************/
   void setupStandardFixture(custom::unordered_set<int> & us)
   {
    ...
    *      h[9] --> 59 49
    *************************************************************/
   void assertStandardFixtureParameters(custom::unordered_set<int>& us, int line, const char * function)
   {
    ...
    *      h[9] -->  
    *************************************************************/
   void assertEmptyFixtureParameters(custom::unordered_set<int>& us, int line, const char* function)
   {
